...
public class BTTower {
	...
	public void createFrame(ClientWaiter clientWaiter) {
		...
		assignMouseListener(up, down, left, right, disconnect, btConnect, clientWaiter);
	...
	private static void assignMouseListener(JButton up, JButton down, JButton left, JButton right, JButton disconnect, JButton btConnect, final ClientWaiter clientWaiter) {
		up.addMouseListener(new MouseListener() {
			
			@Override
			public void mouseReleased(MouseEvent e) {
				try {
					dos.writeInt(Protocol.MOVE_STOP);
					dos.flush();
		...
		down.addMouseListener(new MouseListener() {
			...
			public void mousePressed(MouseEvent e) {
				try {
					dos.writeInt(Protocol.MOVE_DOWN);
					dos.flush();
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
		...
		left.addMouseListener(new MouseListener() {
			...
			public void mouseReleased(MouseEvent e) {
				try {
					dos.writeInt(Protocol.ROTATE_STOP);
					dos.flush();
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
			...
			public void mousePressed(MouseEvent e) {
				try {
					dos.writeInt(Protocol.ROTATE_LEFT);
					dos.flush();
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
		...
		right.addMouseListener(new MouseListener() {
			...
			public void mousePressed(MouseEvent e) {
				try {
					dos.writeInt(Protocol.ROTATE_RIGHT);
					dos.flush();
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
